      ...
      <>
        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 md:gap-16">
          ...
          <div className="col-span-2 row-start-1 place-self-center sm:row-auto sm:justify-self-end">
            <Section.Img src={image_file.data.attributes.url} alt={alternate_text} className="object-cover object-center" />
          </div>
        </div>
      </>
    );
      ...
      {resourcesSafetyViewTextContent.length ? (
        <div className="my-8" aria-label="resources page">
          <Section>
            ...
            <CTALink
              type="external"
              linkTo="https://docs.google.com/forms/d/e/1FAIpQLSdDT9g_BE_74NJzbmh2s9M8CCrg0aU_TCUze4-FCPNkEcZx-Q/viewform"
