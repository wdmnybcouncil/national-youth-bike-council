    ...
    <>
      {advisorsViewTextContent.length ? (
        <div className="my-8" aria-label="advisor page">
          ...
          <Section>
            <Section.Heading>{advisorsViewTextContent[0].attributes.section_heading}</Section.Heading>
            <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 md:gap-16">
              <div className="col-span-2">
                {advisorsViewTextContent[0].attributes.section_text ? <Section.Text>{advisorsViewTextContent[0].attributes.section_text}</Section.Text> : null}
              </div>
          ...
          <Section>
            <Section.Heading>{advisorsViewTextContent[1].attributes.section_heading}</Section.Heading>
            <div className="flex flex-wrap gap-6">{advisorMembers.length ? renderAdvisorMemberCards() : null}</div>
          </Section>
          {/* Section # 3 - How to Become an Advisor  */}
          <Section>
            <Section.Heading>{advisorsViewTextContent[2].attributes.section_heading}</Section.Heading>
            <div className="flex flex-col">
              {advisorsViewTextContent[2].attributes.section_text ? <Section.Text>{advisorsViewTextContent[2].attributes.section_text}</Section.Text> : null}
