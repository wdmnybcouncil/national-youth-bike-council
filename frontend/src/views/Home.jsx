...
import { heroImageAnimationVariants, sectionAnimationVariants, partnersImagesAnimationVariants } from '../utils/animationVariants';
    ...
    <>
      {homeViewTextContent.length ? (
        <div className="my-8" aria-label="home page">
          {/* Section # 1 - Hero */}
          <motion.div className="w-full" variants={sectionAnimationVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
              ...
              <div className="grid grid-cols-2 gap-6 sm:grid-cols-4 md:gap-16">
                <div className="col-span-2 flex flex-col items-center gap-8 place-self-center sm:items-start">
                  ...
                  <p className="max-w-screen-sm text-center text-skin-base sm:text-left">
                    We are a <span className="font-semibold">youth-led non-profit</span> that creates a space for our peers to feel empowered and have the
                    tools, leadership skills, and youth role models necessary to be leaders in their own community.
                  </p>
          ...
          {/* Section # 2 - Mission */}
          <Section>
            <Section.Heading>{homeViewTextContent[0].attributes.section_heading}</Section.Heading>
            <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 md:gap-16">
              <div className="col-span-2">
                {homeViewTextContent[0].attributes.section_text ? <Section.Text>{homeViewTextContent[0].attributes.section_text}</Section.Text> : null}
              </div>
          ...
          <Section>
            <Section.Heading>{homeViewTextContent[1].attributes.section_heading}</Section.Heading>
            <div className="col-span-2">
              {homeViewTextContent[1].attributes.section_text ? <Section.Text>{homeViewTextContent[1].attributes.section_text}</Section.Text> : null}
            </div>
          ...
          {/* Section # 4 - Voices */}
          <Section>
            <Section.Heading>{homeViewTextContent[2].attributes.section_heading}</Section.Heading>
