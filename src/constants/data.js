...
const data = {
  members: [
    ...
    },
    {
      ...
      story: {
        brief:
          "I have learned so much about organizational planning and networking thanks to being on the council. The Council has especially helped me learn how to work well within a group towards a specific goal.",
        detail: [
    ...
    },
    {
      ...
      story: {
        brief:
          "I joined the Council because of my interests in the cycling community, along with my passion for supporting youth voice and the growth of youth leaders.",
        detail: [
    ...
    },
    {
      ...
      story: {
        brief: "",
        detail: [
          "Noah served a crucial role in the upcoming of  the Council by being  the first member out of the home state of Pennsylvania. He also got a chance to represent the Council at the annual Youth Bike Summit while simultaneously being an ambassador of his local bike shop in Seattle Washington.",
        ],
      },
    },
    {
